...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sprite1 = Content.Load<Texture2D>("number1");
            sprite2 = Content.Load<Texture2D>("number2");
            sprite3 = Content.Load<Texture2D>("number3");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > CHANGE_DELAY_TIME)
            {
                ...
                point.X = rand.Next(-4, 5);
                point.Y = rand.Next(-4, 5);
            }

            // STUDENTS: move the drawRectangle by the x speed and the y speed
            drawRectangle.X += point.X;
            drawRectangle.Y += point.Y;
